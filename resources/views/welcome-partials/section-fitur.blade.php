            ...
            @php
                $fiturs = [
                    ...
                    [
                        'judul' => 'Laporan Cepat',
                        'deskripsi' =>
                            'Dapatkan laporan stok barang secara real-time untuk pengambilan keputusan yang lebih baik.',
                    ],
                    [
                        'judul' => 'Akses Multi-User',
                        'deskripsi' => 'Bekerja sama dengan tim Anda,
                                     dengan kontrol hak akses yang terjaga.',
                    ],
                ];
            @endphp
